...
def create_illustration(req: IllustrationRequest):
    ...
    prompt = f"A children's storybook illustration in cute cartoon style. {req.scene}. The characters in this scene: {character_desc}. Wide shot, richly detailed environment, warm golden lighting, vibrant colors."
