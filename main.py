...
def generate_story(req: StoryRequest):
    ...
    system_prompt = (
        ...
        "CORE PRINCIPLE: The image must tell the story. A viewer who has NOT read the text should understand what is happening just by looking at the image. The character is PART of the scene, not the subject of a portrait.\n\n"
        "SHOT RECIPE A — WIDE SCENE WITH CHARACTER REACTING:\n"
        "\"Children's picture book illustration. Wide establishing shot. [DESCRIBE THE FULL SCENE AND ACTION HAPPENING]. In the foreground, [CHARACTER DESCRIPTION VERBATIM] is shown from behind or at an angle, reacting to the scene. The environment and action fill 70% of the image. Whimsical storybook art style, rich background detail, soft lighting.\"\n\n"
        "SHOT RECIPE B — MID-SHOT ACTION SCENE:\n"
        "\"Children's picture book illustration. [CHARACTER DESCRIPTION VERBATIM] is caught mid-action [DESCRIBE EXACTLY WHAT THEY ARE DOING AND WHERE]. The specific object or creature they are interacting with is clearly visible. Background shows [ENVIRONMENT WITH SPECIFIC DETAILS MATCHING THE STORY]. Whimsical storybook art style, sense of motion and energy.\"\n\n"
        "SHOT RECIPE C — HIGH ANGLE STORY SCENE:\n"
        "\"Children's picture book illustration. High angle bird's eye view looking down at [DESCRIBE THE FULL SCENE: character + environment + what is happening]. [CHARACTER DESCRIPTION VERBATIM] appears small within the large environment. Surrounding details show [SPECIFIC STORY ELEMENTS FROM THIS PAGE]. Whimsical storybook art style, rich environmental storytelling.\"\n\n"
        "SHOT RECIPE D — DRAMATIC MOMENT CLOSE SCENE:\n"
        "\"Children's picture book illustration. [CHARACTER DESCRIPTION VERBATIM] and [STORY ELEMENT: object/creature/obstacle] fill the frame together. [DESCRIBE THE SPECIFIC INTERACTION OR DRAMATIC MOMENT HAPPENING]. Background shows [ENVIRONMENT]. Whimsical storybook art style, dramatic tension, expressive emotion.\"\n\n"
        "SHOT RECIPE E — DISCOVERY ENTRY SCENE (MANDATORY FOR PAGE 1):\n"
        "\"Children's picture book illustration. [CHARACTER DESCRIPTION VERBATIM] stepping into [NEW LOCATION FROM THE STORY]. Three-quarter back view, character in foreground. The new world opens up before them: [DESCRIBE SPECIFIC DETAILS OF THIS LOCATION THAT ARE RELEVANT TO THE STORY]. Something interesting is already visible in the scene that hints at the adventure ahead. Whimsical storybook art style, sense of discovery and wonder.\"\n\n"
        "SHOT RECIPE F — EPIC CONCLUSION SCENE (MANDATORY FOR LAST PAGE):\n"
        "\"Children's picture book illustration. Wide shot showing [DESCRIBE THE RESOLUTION OR FINAL MOMENT OF THE STORY]. [CHARACTER DESCRIPTION VERBATIM] shown small from behind in the foreground. The environment reflects the story's conclusion: [DESCRIBE WHAT HAS CHANGED OR BEEN ACHIEVED]. Whimsical storybook art style, emotional payoff, sense of wonder and completion.\"\n\n"
        "SHOT TYPE RULES:\n"
        ...
        "- NEVER write a centered front-facing portrait\n"
